...
<body>
	<div class="under_construction">
		<p>This website is not finished, excuse the minor visual bugs, lack of content, and lots of placeholder text (Lorem ipsium)</p>
		<a>OK</a>
	</div>
	...
	<div class="side_menu">
		<ul class="side_menu_list">
			...
			<li class="side_menu_list_item"><a class="side_menu_list_item_link" href="#projects">Projects</a></li>
			<li class="side_menu_list_item"><a class="side_menu_list_item_link" href="#contact">Contact</a></li>
		</ul>
	</div>
	<div class="home">
		<div class="intro">
			<h1 class="intro_h1">Hi, im <div class="highlighted_text">Francesco Gorini</div>,<br>
				A Software Engineering student
			</h1>
			<a class="home_about_me_btn" href="#about_me_skills_divider">Projects <i class="fas fa-arrow-right rotate"></i></a>
		</div>
	</div>
			...
			<ul class="projects_list">
			    <li>
                    ...
                    <article>
                        ...
                        Each user has their own storage, also has `shared/public` storage which are files that can be seen/downloaded by other users.
                        Max file upload is 20MB because i lack HDD space. Was hosted on RaspberryPi, code will be uploaded on github soon'</p>
                        <div class="links">
				...
				<li>
					<div class="projects_list_link_container">
						<a class="projects_list_link" href="mainframe/index.php">
							<div><p>Front-end: HTML, CSS and JS with JQuery framework<br>Back-end: PHP and MYSQLi</p></div>
						</a>
					</div>
					<article>
						<h1>Mainframe</h1>
		...
		<div class="about_wrap">
			<div class="about_container">
				<div class="about_profile_container">
					<img src="resources/profile.jpg" alt="Me" class="profile_pic"></img>
				</div>
				<div class="about_me">
					<h1>About me</h1>
					<p>I am a 3rd year student in Software Engineering in Victoria University of Wellington (VUW)
						I have a passion for learning. I am interested in:
...
<footer class="contact">
	...
	<ul class="social_list">
		...
		<li><a href="https://github.com"><i class="fab fa-github fa-2x"></i></a></li>
	</ul>
</footer>
</body>
